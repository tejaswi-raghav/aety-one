...
type View = 'home' | 'drop' | 'archive' | 'cart' | 'product';
  ...
  return <>
    <header className="nav">
      ...
      <nav className="nav-links" aria-label="Primary navigation">
        <a href="/drop-01">SHOP</a><a href="/drop-01">DROP 01</a><a href="/archive">ARCHIVE</a><a href="/#manifesto">MANIFESTO</a>
      </nav>
    ...
    {menuOpen && <div className="mobile-menu"><a href="/drop-01">DROP 01</a><a href="/archive">ARCHIVE</a><a href="/#manifesto">MANIFESTO</a><button onClick={openCart}>CART ({count})</button><small>SYSTEM ACTIVE / 2026</small></div>}
  </>;
}
